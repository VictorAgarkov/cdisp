...
#define CDISP_MONOBMP_WIDTH   80
#define CDISP_MONOBMP_HEIGHT  200

#ifdef CDISP_MONOBMP_HEIGHT
	#define CDISP_MONOBMP_HEIGHT_L ((CDISP_MONOBMP_HEIGHT + 7) / 8)  // height in 8-bit lines
#endif
...
void cdisp_text_p(struct point *P, struct text_def *txt);
	...
	extern char cdisp_2_mono;
	#define CDISP_TO_MONO cdisp_2_mono
	...
	#define CDISP_TO_MONO 0
	#define cdisp_monobmp_flush(a,b,c,d)
